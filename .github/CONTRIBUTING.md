...
No problem! You can learn how from this _free_ series, [How to Contribute to an Open Source Project on GitHub](https://egghead.io/series/how-to-contribute-to-an-open-source-project-on-github).
...
If you find a security vulnerability, do NOT open an [issue](https://github.com/ensono/stacks-terraform/issues/new/choose). Email [Amido](mailto:stacks@amido.com) instead.
