resource "azurerm_data_factory_linked_service_sql_server" "fcAzureSqlConnectionString" {
  ...
  connection_string = "Integrated Security=False;Data Source=fc-mssqlserver.database.windows.net;Initial Catalog=fc-mssql_db;User ID=missadministrator;Password=thisIsKat11"
}
